...
#define SHGregorianCalendar NSCalendarIdentifierGregorian
#else
#define SHGregorianCalendar NSGregorianCalendar
#endif


#pragma mark - Readwrite accessors only private
@interface SHSunriseSet()
...
@implementation SHSunriseSet(Calculations)
...
@implementation SHSunriseSet(Private)
...
@implementation SHSunriseSet

#pragma mark - Initialization

-(SHSunriseSet*)initWithDate:(NSDate*)date timezone:(NSTimeZone*)tz latitude:(double)latitude longitude:(double)longitude {
    self = [super init];
    if( self )
    {
        ...
        self.calendar = [[NSCalendar alloc] initWithCalendarIdentifier:SHGregorianCalendar];
...
+(SHSunriseSet*)sunrisesetWithDate:(NSDate*)date timezone:(NSTimeZone*)tz latitude:(double)latitude longitude:(double)longitude {
    return [[SHSunriseSet alloc] initWithDate:date timezone:tz latitude:latitude longitude:longitude];
}
